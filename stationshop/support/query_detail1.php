...
if (isset($_POST['status'])) {
   ...
   echo "<script>window.location = 'querysolved.php';</script>";
    exit();
}
?>
<?php 
    ...
    <div id="main">
        <div id="header">
            <a href="#" class="logo"><img src="img/logo.png" width="183" height="36" alt="" /></a>
                ...
                <li><a href="index.php" >New Query</a></li>
                <li><a href="querysolved.php" class="active">Old Query</a></li>
        ...
        <div id="middle">
            ...
            <div id="center-column">
              ...
              <div id="center-column2">
                ...
                <form action="query_detail1.php" enctype="multipart/form-data" name="myForm" id="myform" method="post">
