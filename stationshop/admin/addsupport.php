...
if (isset($_POST['name'])) {
	...
	$username = "";
	$sql = mysql_query("SELECT * FROM support_login where username='$uname'");
		while ($row = mysql_fetch_array($sql)) {
			$username = $row["username"];
		}
	if($uname != $username && $password != ""){
	$sql = mysql_query("INSERT INTO support_login (username, password, name, email, mobileno, city, state, address, last_log_date) 
    ...
    <div id="main">
        ...
        <div id="middle">
            ...
            <div id="center-column">
              ...
              <div >
                   <form action="addsupport.php" enctype="multipart/form-data" name="myForm" id="myform" method="post">
