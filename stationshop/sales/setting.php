    ...
    <div id="main">
        <div id="header">
            ...
            <ul id="top-navigation">
                ...
                <li><a href="setting.php" class="active"><? echo "Hello ".$managersa; ?></a></li>
            </ul>
